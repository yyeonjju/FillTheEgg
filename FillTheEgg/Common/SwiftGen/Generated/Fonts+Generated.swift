...
internal enum FontFamily {
  ...
  internal enum Suit {
    internal static let extraBold = FontConvertible(name: "SUIT-ExtraBold", family: "SUIT", path: "SUIT-ExtraBold.otf")
    internal static let regular = FontConvertible(name: "SUIT-Regular", family: "SUIT", path: "SUIT-Regular.otf")
    internal static let semiBold = FontConvertible(name: "SUIT-SemiBold", family: "SUIT", path: "SUIT-SemiBold.otf")
    internal static let all: [FontConvertible] = [extraBold, regular, semiBold]
  }
  internal static let allCustomFonts: [FontConvertible] = [Pretendard.all, Suit.all].flatMap { $0 }
